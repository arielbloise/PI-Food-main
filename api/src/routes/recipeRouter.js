...
recipeRouter.post('/', async (req, res) => {
    ...
    try{
        if(!nombre||!imagen||!resumen||!healthscore||!pasos||!dietas) throw Error('Faltan datos...');
        else{
          const newRecipe = await postRecipe(nombre, imagen, resumen, healthscore, pasos, dietas);  
